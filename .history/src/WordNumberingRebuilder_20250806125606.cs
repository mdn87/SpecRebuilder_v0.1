...
namespace SpecRebuilder
{
    ...
    public class WordNumberingRebuilder
    {
        ...
        private Paragraph CreateParagraph(ParagraphInfo paraInfo, Dictionary<int, uint> numberingMap)
        {
            ...
            // Debug output
            Console.WriteLine($"Paragraph: '{paraInfo.DisplayText}' | ListNumber: '{paraInfo.ListNumber}' | Level: {paraInfo.Level} | IsListItem: {paraInfo.IsListItem}");
            ...
            if (paraInfo.IsListItem && paraInfo.Level.HasValue)
            {
                ...
                {
                    Console.WriteLine($"  -> Adding numbering for level {level} with numId {numId}");
                ...
                {
                    Console.WriteLine($"  -> WARNING: No numbering found for level {level}");
                }
            }
            else
            {
                Console.WriteLine($"  -> Not a list item or no level");
            }
