    ...
    public class WordNumberingRebuilder
    {
        ...
        private Dictionary<int, uint> CreateNumberingDefinitions(NumberingDefinitionsPart numberingPart, List<ParagraphInfo> paragraphs)
        {
            ...
            foreach (var level in levelsUsed)
            {
                ...
                levelElement.AppendChild(new NumberingFormat { Val = listDef.NumFmt });
                ...
                {
                    Left = (StringValue)(listDef.Indent.ToString()),
                    Hanging = (StringValue)(listDef.Hanging.ToString())
                };
                pPr.AppendChild(ind);
                ...
                num.AppendChild(new AbstractNumId { Val = abstractId });
