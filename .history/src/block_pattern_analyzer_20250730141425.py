...
class BlockPatternAnalyzer:
    ...
    def analyze_text_patterns(self) -> List[PatternMatch]:
        ...
        spec_patterns = [
            ...
            (r'^BWA-PART', 0, 0.9),  # BWA-PART
            (r'^BWA-SUBSECTION', 1, 0.8),  # BWA-SUBSECTION
            (r'^BWA-Item', 2, 0.7),  # BWA-Item
            (r'^BWA-List', 3, 0.6),  # BWA-List
            (r'^BWA-SubItem', 4, 0.5),  # BWA-SubItem
            (r'^BWA-SubList', 5, 0.4),  # BWA-SubList
        ]
        
        # Test patterns against blocks with known levels
        for pattern, suggested_level, confidence in spec_patterns:
            ...
            for block in self.blocks:
                if block.block_type == "content" and block.level_number is not None:
                    total_with_level += 1
            ...
            if total_with_level > 0:
                actual_confidence = (matches / total_with_level) * confidence
                if matches > 0:
