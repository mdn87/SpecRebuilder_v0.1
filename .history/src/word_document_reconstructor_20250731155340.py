...
class WordDocumentReconstructor:
        ...
        try:
            ...
            for para_data in paragraphs:
                ...
                if has_numbering:
                    ...
                    # Apply numbering
                    self.apply_numbering_to_paragraph(para, numbering, level, list_objects)
    ...
    def apply_numbering_to_paragraph(self, para, numbering: str, level: int, list_objects: Dict):
